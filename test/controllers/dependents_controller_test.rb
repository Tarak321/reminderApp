...
class DependentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dependent" do
    assert_difference('Dependent.count') do
      post dependents_url, params: { dependent: { blood_group: @dependent.blood_group, contact_number: @dependent.contact_number, date_of_birth: @dependent.date_of_birth, email_address: @dependent.email_address, height: @dependent.height, name: @dependent.name, relationship: @dependent.relationship, user_id: @dependent.user_id, weight: @dependent.weight } }
    end
  ...
  test "should update dependent" do
    patch dependent_url(@dependent), params: { dependent: { blood_group: @dependent.blood_group, contact_number: @dependent.contact_number, date_of_birth: @dependent.date_of_birth, email_address: @dependent.email_address, height: @dependent.height, name: @dependent.name, relationship: @dependent.relationship, user_id: @dependent.user_id, weight: @dependent.weight } }
